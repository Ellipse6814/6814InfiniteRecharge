...
// System.out.println("TableRotateToRotations: displacement " + displacement + "
// edges");

// direction = getSign(displacement);
// degToSpinTable = displacement * 45 + 15 * direction; // spin to middle after
// arrived at color
...
// System.out.println("TableRotateToRotations: rotating " + degToSpinRoller +
// "deg");
...
// System.out.println("ActualWrongEcoderVal: " +
// tableSpinner.getEncoderPosition());
...
// System.out.println(
// "TableRotateToRotations: met tolerance " +
// Math.abs(tableSpinner.getEncoderVelocity()) + "deg/s");
